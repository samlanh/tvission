$(document).ready(function(){
  ...
  ------------------------------------------------------------------------- */
	...
	function onChange() {
		...
		$("#pickupdate").val(month+'/'+valueda.getDate()+'/'+valueda.getFullYear());
...
var bestLocation = new Bloodhound({
  datumTokenizer: Bloodhound.tokenizers.obj.whitespace('name'),
  queryTokenizer: Bloodhound.tokenizers.whitespace,
  prefetch: APP_URL+"/jquery/location.json"
...
$('#custom-templates .typeahead').typeahead(null, {
  ...
  templates: {
    ...
    suggestion: Handlebars.compile('<div><strong>{{name}}</strong> – {{country_name}}</div>')
  }
});

var bestLocationto = new Bloodhound({
  datumTokenizer: Bloodhound.tokenizers.obj.whitespace('name'),
  queryTokenizer: Bloodhound.tokenizers.whitespace,
  prefetch: APP_URL+"/jquery/location.json"
...
$('#to_location .typeahead').typeahead(null, {
  name: 'to',
  display: 'name',
  source: bestLocationto,
  templates: {
    empty: [
      '<div class="empty-message">',
  ...
  ------------------------------------------------------------------------- 
   $(window).scroll(function () {
			...
			if ($(window).scrollTop()>140 ) {
				$('.header-nav').addClass('navigation-fix-to-top');
				
					
			} else {
				$('.header-nav').removeClass('navigation-fix-to-top');
			} 
	 });
		 */
  ...
  var blogsearch = $('#hero-tabs').height();
  $('#banner, #banner .banner-bg, #banner .banner-bg-item').each(function () {
    var $this = $(this);

    $this.css('height', windowHeight-blogsearch+100);
  });
