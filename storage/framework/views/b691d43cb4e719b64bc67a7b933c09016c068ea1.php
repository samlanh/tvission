...
<html lang="en-us">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo e($urlFromBack.'/icon.ico'); ?>">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 col-lg-offset-4 col-md-offset-2 header-right">
                  ...
                  <div class="header-login">
                    <a class="header-btn" href="<?php echo e(url('/user/sign_in')); ?>"> <i class="fa fa-key"></i>
                    <?php echo e(trans('language.sign_in')); ?></a>                                 
                  </div>
                  <!-- End Header-Login -->
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 widget widget-newsletter">
                ...
                <form class="default-form">
                  ...
                  <button class="btn light"><?php echo e(trans('language.sign_up')); ?></button>
                </form>
              </div>
  ...
  <script src="<?php echo e(asset('assets/js/typeahead/handlebars-v4.0.11.js')); ?>"></script>
	<script>
    var states = [];
